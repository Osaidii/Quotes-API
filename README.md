...
## Personal Hosting
If you would like to host this API for Yourself on a separate server of your own, please refer to this [file](https://github.com/Osaidii/Quotes-API/blob/main/SELF-HOSTING.md). 
